...
class SegMattingNet(nn.Module):
    def __init__(self):
        ...
        # feather
        self.convF1 = nn.Conv2d(in_channels=10, out_channels=5, kernel_size=(3, 3), stride=1, padding=1, dilation=1, groups=1, bias=True)
        self.bn = nn.BatchNorm2d(num_features=5)
        self.ReLU = nn.ReLU(inplace=True)
        self.convF2 = nn.Conv2d(in_channels=5, out_channels=2, kernel_size=(3, 3), stride=1, padding=1, dilation=1, groups=1, bias=True)
